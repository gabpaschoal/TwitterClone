...
namespace TwitterClone.Resources {
    ...
    public class ValidationMessage {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Already exists an user with this email.
        /// </summary>
        public static string AlreadyExistsAnUserWithThisEmail {
            get {
                return ResourceManager.GetString("AlreadyExistsAnUserWithThisEmail", resourceCulture);
            }
        }
        ...
        public static string HasMaxLenghtMessage {
            get {
                return ResourceManager.GetString("HasMaxLenghtMessage", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Should be more than {0} lenght.
        /// </summary>
